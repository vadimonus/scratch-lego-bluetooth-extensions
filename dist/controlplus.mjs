...
var BleBaseBlocks$1 = /*#__PURE__*/function () {
  ...
  _createClass(BleBaseBlocks, [{
    ...
    key: "setHubLEDColorRGB",
    value: function setHubLEDColorRGB(args) {
      var red = Cast.toNumber(args.RED);
      var green = Cast.toNumber(args.GREEN);
      var blue = Cast.toNumber(args.BLUE);
      return this._peripheral.setLEDColorRGB(red, green, blue).then(waitPromise);
    }
  }, {
    key: "setHubLEDColorHSV",
    value: function setHubLEDColorHSV(args) {
      var rgb = UtilColor.hsvToRgb({
...
var Hub$1 = /*#__PURE__*/function () {
  ...
  _createClass(Hub, [{
    ...
    key: "setLEDColorRGB",
    value: function setLEDColorRGB(red, green, blue) {
      var portId = this._devices.findIndex(function (device) {
        return device && device.ioType == IOType.RGB_LIGHT;
      });
      if (portId != -1) {
...
var Scratch3ControlPlusBlocks = /*#__PURE__*/function (_BleBaseBlocks) {
  ...
  function Scratch3ControlPlusBlocks(runtime) {
    ...
    _this = _callSuper(this, Scratch3ControlPlusBlocks, [new Hub(runtime, Scratch3ControlPlusBlocks.EXTENSION_ID, 0x80)]);
